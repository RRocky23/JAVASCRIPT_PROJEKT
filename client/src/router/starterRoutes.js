...
import StarterSelection from "../views/starterViews/StarterSelection.vue";
...
export default [
  ...
  { path: '/starter/select-pokemon', name: 'StarterSelection', component: StarterSelection, meta: { requiresAuth: true } }
];
